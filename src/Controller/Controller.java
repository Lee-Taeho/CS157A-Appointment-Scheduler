...
public class Controller {
    ...
    private JDBC model; // Direct reference to model
    private GameInfo gameInfo; // Direct reference to the state of the Game/Application

    private List<Valve> valves = new LinkedList<Valve>();

    public Controller(View view, JDBC model, BlockingQueue<Message> queue) {
        this.view = view;
        this.model = model;
        this.queue = queue;
        ...
        /**
         * add valve for each message types
         */
    }
    ...
    /**
     * Valve classes: List of Valves for each message type that needs to be implemented.
     */
